...
//@Ignore // Все эти тесты пока игнорируются, поскольку JDBC-модуль не работает должным образом!
public class UdmManagerTest extends TestApi{
    ...
    public static void setUp(){
        manager = UdmManagerJDBC.getInstance(UdmManagerJDBC.Driver.Derby);
    }
